...
class SpotifyClient:
    ...
    def get_album(self, value: str) -> Album:
        ...
        album, session, tier1 = self._get_entity(
            "album",
            entity_id,
            "albumUnion",
    ...
    def get_playlist(self, value: str, *, max_tracks: int | None = 100) -> Playlist:
        ...
        playlist, session, tier1 = self._get_entity(
            "playlist",
            entity_id,
            "playlistV2",
    ...
    def get_show(self, value: str) -> Show:
