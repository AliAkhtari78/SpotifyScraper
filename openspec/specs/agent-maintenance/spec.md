# agent-maintenance Specification

## Purpose

Govern the automated maintenance agent that diagnoses canary-reported breakages under least privilege and a human-gated autonomy ladder.
