...
- Home / Made-for-you was investigated and **deferred**: its `home` op variable
  is not GET-encodable (rejects every JSON kind) and needs the pathfinder v2 POST
  path — documented rather than shipped broken.
