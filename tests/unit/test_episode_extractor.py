...
class TestEpisodeExtractor:
    ...
    def test_extract_valid_episode_url(self, extractor, mock_browser, sample_episode_embed_html):
        """Test extracting episode data from a valid URL."""
        mock_browser.get_page_content.return_value = sample_episode_embed_html
        
        result = extractor.extract("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G")
        ...
        assert result["audio_preview_url"] == "https://podz-content.spotifycdn.com/audio/clips/preview.mp3"
    ...
    def test_extract_preview_url(self, extractor, mock_browser, sample_episode_embed_html):
        """Test extracting preview URL only."""
        mock_browser.get_page_content.return_value = sample_episode_embed_html
        
        preview_url = extractor.extract_preview_url("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G")
    ...
    def test_extract_cover_url(self, extractor, mock_browser, sample_episode_embed_html):
        ...
        cover_url = extractor.extract_cover_url("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G")
    ...
    def test_spotify_uri_support(self, extractor, mock_browser, sample_episode_embed_html):
    ...
    def test_extract_full_audio_url(self, extractor, mock_browser):
        ...
        full_urls = extractor.extract_full_audio_url("https://open.spotify.com/episode/test")
