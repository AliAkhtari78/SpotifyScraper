...
class TestPodcastURLUtilities:
    ...
    def test_get_url_type_podcast(self):
        ...
        assert get_url_type("https://open.spotify.com/embed/episode/5Q2dkZHfnGb2Y4BzzoBu2G") == "episode"
        ...
        assert get_url_type("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G?si=abcd") == "episode"
        assert get_url_type("https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk?si=efgh") == "show"

    def test_extract_id_podcast(self):
        """Test extract_id with podcast URLs."""
        # Episode IDs
        assert extract_id("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G") == "5Q2dkZHfnGb2Y4BzzoBu2G"
        assert extract_id("https://open.spotify.com/embed/episode/5Q2dkZHfnGb2Y4BzzoBu2G") == "5Q2dkZHfnGb2Y4BzzoBu2G"
        assert extract_id("spotify:episode:5Q2dkZHfnGb2Y4BzzoBu2G") == "5Q2dkZHfnGb2Y4BzzoBu2G"
        
        # Show IDs
        assert extract_id("https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk") == "4rOoJ6Egrf8K2IrywzwOMk"
        assert extract_id("https://open.spotify.com/embed/show/4rOoJ6Egrf8K2IrywzwOMk") == "4rOoJ6Egrf8K2IrywzwOMk"
        assert extract_id("spotify:show:4rOoJ6Egrf8K2IrywzwOMk") == "4rOoJ6Egrf8K2IrywzwOMk"
        
        # With query parameters
        assert extract_id("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G?si=abcd&utm_source=copy") == "5Q2dkZHfnGb2Y4BzzoBu2G"

    def test_convert_to_embed_url_podcast(self):
        """Test convert_to_embed_url with podcast URLs."""
        # Episode conversions
        assert convert_to_embed_url("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G") == \
               "https://open.spotify.com/embed/episode/5Q2dkZHfnGb2Y4BzzoBu2G"
        assert convert_to_embed_url("spotify:episode:5Q2dkZHfnGb2Y4BzzoBu2G") == \
               "https://open.spotify.com/embed/episode/5Q2dkZHfnGb2Y4BzzoBu2G"
        
        # Show conversions
        assert convert_to_embed_url("https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk") == \
               "https://open.spotify.com/embed/show/4rOoJ6Egrf8K2IrywzwOMk"
        assert convert_to_embed_url("spotify:show:4rOoJ6Egrf8K2IrywzwOMk") == \
               "https://open.spotify.com/embed/show/4rOoJ6Egrf8K2IrywzwOMk"
        
        # Already embed URLs should remain unchanged
        assert convert_to_embed_url("https://open.spotify.com/embed/episode/5Q2dkZHfnGb2Y4BzzoBu2G") == \
               "https://open.spotify.com/embed/episode/5Q2dkZHfnGb2Y4BzzoBu2G"

    def test_validate_url_podcast(self):
        """Test validate_url with podcast URLs."""
        # Valid episode URLs
        assert validate_url("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G", expected_type="episode")
        assert validate_url("spotify:episode:5Q2dkZHfnGb2Y4BzzoBu2G", expected_type="episode")
        
        # Valid show URLs
        assert validate_url("https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk", expected_type="show")
        ...
        with pytest.raises(URLError, match="not a Spotify episode URL"):
            validate_url("https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk", expected_type="episode")
        
        with pytest.raises(URLError, match="not a Spotify show URL"):
            validate_url("https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G", expected_type="show")

    def test_build_url_podcast(self):
        """Test build_url with podcast types."""
        # Build episode URL
        assert build_url("episode", "5Q2dkZHfnGb2Y4BzzoBu2G") == \
               "https://open.spotify.com/episode/5Q2dkZHfnGb2Y4BzzoBu2G"
        
        # Build show URL
        assert build_url("show", "4rOoJ6Egrf8K2IrywzwOMk") == \
               "https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk"
        
        # Build embed URLs
        assert build_url("episode", "5Q2dkZHfnGb2Y4BzzoBu2G", embed=True) == \
               "https://open.spotify.com/embed/episode/5Q2dkZHfnGb2Y4BzzoBu2G"
        assert build_url("show", "4rOoJ6Egrf8K2IrywzwOMk", embed=True) == \
               "https://open.spotify.com/embed/show/4rOoJ6Egrf8K2IrywzwOMk"
        
        # With query parameters
        assert build_url("episode", "5Q2dkZHfnGb2Y4BzzoBu2G", query_params={"si": "abc123"}) == \
    ...
    def test_spotify_uri_conversion_podcast(self):
        ...
        assert convert_url_to_spotify_uri("https://open.spotify.com/embed/episode/5Q2dkZHfnGb2Y4BzzoBu2G") == episode_uri
        assert convert_url_to_spotify_uri("https://open.spotify.com/embed/show/4rOoJ6Egrf8K2IrywzwOMk") == show_uri
