...
class TestShowExtractor:
    ...
    def test_extract_valid_show_url(self, extractor, mock_browser, sample_show_embed_html, sample_regular_show_html):
        ...
        result = extractor.extract("https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk")
    ...
    def test_extract_by_id(self, extractor, mock_browser, sample_show_embed_html, sample_regular_show_html):
        """Test extracting show by ID."""
        mock_browser.get_page_content.side_effect = [sample_show_embed_html, sample_regular_show_html]
        ...
        assert "https://open.spotify.com/embed/show/4rOoJ6Egrf8K2IrywzwOMk" in str(first_call)

    def test_extract_cover_url(self, extractor, mock_browser, sample_show_embed_html, sample_regular_show_html):
        """Test extracting cover image URL."""
        mock_browser.get_page_content.side_effect = [sample_show_embed_html, sample_regular_show_html]
        
        cover_url = extractor.extract_cover_url("https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk")
    ...
    def test_extract_episodes_list(self, extractor, mock_browser):
        ...
        episodes = extractor.extract_episodes_list("https://open.spotify.com/show/test123")
    ...
    def test_spotify_uri_support(self, extractor, mock_browser, sample_show_embed_html, sample_regular_show_html):
